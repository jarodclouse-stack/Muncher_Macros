...
export function normalizeFoodItem(raw: any = {}): any {
  ...
  return {
    ...
    calories: Math.round(num(raw.calories != null ? raw.calories : (raw.cal != null ? raw.cal : (raw.energy != null ? raw.energy : (raw.kcal != null ? raw.kcal : raw.nutrients && raw.nutrients.calories))), 0)),
...
export function toLegacyFood(normalized: any = {}): any {
  return {
    ...
    cal: Math.round(num(normalized.calories)),
